...
################################################################################
## Methods for creating / sampling synthetic dataset ###########################
################################################################################
...
def data_mouse():
	"""
	X,Y = dataMouse() : simple by-hand data generation function
	Opens a matplotlib plot window, and allows the user to specify points with the mouse.
	Each button is its own class (1,2,3)
	Close the window when done creating data
	"""
